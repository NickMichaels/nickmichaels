...
![MySQL](https://img.shields.io/badge/DB-MySQL-informational?style=flat&logo=mysql&color=F7DF1E)
![PostreSQL](https://img.shields.io/badge/DB-PostgreSQL-informational?style=flat&logo=postgresql&color=F7DF1E)
![Laravel](https://img.shields.io/badge/Framework-Laravel-informational?style=flat&logo=laravel&color=FF2D20)
![Symfony](https://img.shields.io/badge/Framework-Symfony-informational?style=flat&logo=symfony&color=FF2D20)
![Laminas](https://img.shields.io/badge/Framework-Laminas-informational?style=flat&logo=zend&color=FF2D20)
![Django](https://img.shields.io/badge/Framework-Django-informational?style=flat&logo=django&color=FF2D20)
...
- 🔭 I’m currently working on: A patient referral system (first an API, then a frontend) in various backend and frontened frameworks. Then an Allowances project (in a few different frameworks, as time allows), so I can stop using a spreadsheet :P
